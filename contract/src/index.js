...
export const Escrow3PartyContractComplied = CompiledContract.make("Escrow3party", (CompiledEscrow3PartyContract.Contract)).pipe(CompiledContract.withWitnesses(Witnesses.witnesses), CompiledContract.withCompiledFileAssets("./managed/escrow3party"));
